...
{
    public class LoginUserValidator : IValidationHandler<LoginUserQuery>
    {
        private readonly CustomerSignInManager _signInManager;
        private readonly UserManager<User> _userManager;
        private readonly IValidationService _validationService;

        public LoginUserValidator(UserManager<User> userManager, CustomerSignInManager signInManager,
        ...
        public async Task<ValidationResult> Validate(LoginUserQuery request, CancellationToken cancellationToken)
        {
