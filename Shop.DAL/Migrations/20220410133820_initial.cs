    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValue: new DateTime(2022, 4, 10, 16, 38, 20, 182, DateTimeKind.Local).AddTicks(6746)),
                    CountryId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Standard = table.Column<string>(type: "text", nullable: true, defaultValue: "EU"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubType_ItemTypes_ItemTypeId",
                        column: x => x.ItemTypeId,
                        principalTable: "ItemTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expire = table.Column<string>(type: "text", nullable: false, defaultValue: "1654781900"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Characteristics_AgeTypes_AgeTypeItemId",
                        column: x => x.AgeTypeItemId,
                        principalTable: "AgeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characteristics_Colors_ColorId",
                        column: x => x.ColorId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characteristics_Genders_GenderId",
                        column: x => x.GenderId,
                        principalTable: "Genders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characteristics_ItemTypes_ItemTypeId",
                        column: x => x.ItemTypeId,
                        principalTable: "ItemTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characteristics_Seasons_SeasonItemId",
                        column: x => x.SeasonItemId,
                        principalTable: "Seasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characteristics_SubType_SubTypeItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfSales = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Items_Characteristics_CharacteristicItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NumberOfSizes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NumberOfSizes_Characteristics_CharacteristicItemId",
                        column: x => x.CharacteristicItemId,
                        principalTable: "Characteristics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NumberOfSizes_Sizes_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_AgeTypeItemId",
                table: "Characteristics",
                column: "AgeTypeItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_ColorId",
                table: "Characteristics",
                column: "ColorId");

            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_GenderId",
                table: "Characteristics",
                column: "GenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_ItemTypeId",
                table: "Characteristics",
                column: "ItemTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_SeasonItemId",
                table: "Characteristics",
                column: "SeasonItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Characteristics_SubTypeItemId",
                table: "Characteristics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NumberOfSizes_CharacteristicItemId",
                table: "NumberOfSizes",
                column: "CharacteristicItemId");

            migrationBuilder.CreateIndex(
                name: "IX_NumberOfSizes_SizeId",
                table: "NumberOfSizes",
                column: "SizeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubType_ItemTypeId",
                table: "SubType",
                column: "ItemTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SubType_Title",
                table: "SubType",
                column: "Title",
                unique: true);
